...
class WeatherapiBox extends Module
{
	...
	const CONFIG_KEY         = 'WEATHERAPIBOX_API_KEY'; //For test Use Weatherapi Api Key: 577c0e84f57b4dcba8301631201709
	...
	public function __construct()
	{
		...
		$this->description            = $this->l('Muestra el estado climatológico de la localidad del cliente en el frontend ('. static::HOOK_TARGET .')');
		$this->displayName            = $this->l('A WeatherApi Box');
	...
	protected function formInputs()
	{
		...
		array_push($inputs, [
			...
			'hint'     => $this->l('Weatherapi Api Key'),
			'required' => true,
